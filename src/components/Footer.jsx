// Footer with social links and ARIA landmarks
function Footer() {
  return (
    <footer className="relative z-50 mt-auto border-t border-white/10 bg-black text-white/80" role="contentinfo">
      <div className="w-full px-6 md:px-16 py-10 md:py-12 flex flex-col md:flex-row gap-6 md:gap-8 md:items-center md:justify-between">
        ...
        <nav aria-label="Social media links" className="flex flex-wrap gap-3 md:gap-4 text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold">
          ...
          <a href="https://www.artstation.com/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 border border-white/20 rounded-full hover:bg-white hover:text-black transition-all duration-300">
